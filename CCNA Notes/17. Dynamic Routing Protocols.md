...
- When a matching peer is found, the routers form an adjaceny with each other, then they exchange routing information
...
- Only routers which are running the sam routing protocol will process the packet
